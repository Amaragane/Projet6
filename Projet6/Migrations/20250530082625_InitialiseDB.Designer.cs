...
namespace Projet6.Migrations
{
    ...
    [Migration("20250530082625_InitialiseDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projet6.Models.OsModel", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projet6.Models.ProductModel", b =>
                {
            ...
            modelBuilder.Entity("Projet6.Models.ProductVersionOsSupport", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductId", "VersionId", "OsId");

                    b.HasIndex("OsId");

                    b.HasIndex("VersionId");

                    b.ToTable("ProductVersionOsSupport", (string)null);
            ...
            modelBuilder.Entity("Projet6.Models.StatutModel", b =>
                {
            ...
            modelBuilder.Entity("Projet6.Models.TicketModel", b =>
                {
            ...
            modelBuilder.Entity("Projet6.Models.VersionModel", b =>
                {
                    b.Property<int>("VersionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projet6.Models.ProductVersionOsSupport", b =>
                {
                    b.HasOne("Projet6.Models.OsModel", "Os")
                        .WithMany()
                        .HasForeignKey("OsId")
                    ...
                    b.HasOne("Projet6.Models.ProductModel", "Product")
                        .WithMany()
                    ...
                    b.HasOne("Projet6.Models.VersionModel", "Version")
                        .WithMany()
            ...
            modelBuilder.Entity("Projet6.Models.TicketModel", b =>
                {
                    ...
                    b.HasOne("Projet6.Models.StatutModel", "Statut")
                        .WithMany("Tickets")
